...
def main_menu_kb() -> ReplyKeyboardMarkup:
    return ReplyKeyboardMarkup(
        keyboard=[
            ...
            [KeyboardButton(text="🎯 Моя цель"), KeyboardButton(text="📋 Задача дня")],
...
def after_session_kb() -> InlineKeyboardMarkup:
    return InlineKeyboardMarkup(inline_keyboard=[
        ...
        [
            ...
            InlineKeyboardButton(text="📋 Задача дня", callback_data="after_review"),
        ]
    ])
...
def task_day_kb(has_task: bool) -> InlineKeyboardMarkup:
    buttons = []
    if has_task:
        buttons.append([
...
def evening_audit_kb() -> InlineKeyboardMarkup:
    return InlineKeyboardMarkup(inline_keyboard=[
        [
            InlineKeyboardButton(text="✅ Да, выполнил 😎", callback_data="evening_yes"),
            InlineKeyboardButton(text="❌ Нет, провалил 😔", callback_data="evening_no"),
